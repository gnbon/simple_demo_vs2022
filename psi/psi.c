...
int main(int argc, char *argv[]) {
  ...
  swprintf_s(output_directory, MAX_FILE_PATH, L"%lspsi/", output_path);
  ...
  swprintf_s(output_file, MAX_FILE_PATH, L"%lspressure_sensitive_ink.bmp", output_directory);

  FSDK_Image_SaveAs(image, output_file, &return_value);
  ...
  swprintf_s(output_file, MAX_FILE_PATH, L"%lspressure_sensitive_ink.pdf", output_directory);

  FSDK_PDFDoc_StartSaveAs(doc, output_file, e_FSSaveFlagNoOriginal, NULL, &return_progresive_value);
